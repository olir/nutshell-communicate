...
import de.serviceflow.nutshell.cl.intern.NioObjectIOHelper;
...
public abstract class NioStruct implements Transferable {
	...
	private final NioObjectIOHelper ioHelper;
	...
	protected NioStruct(int initialcapacity) {
		if (initialcapacity < 2) {
			initialcapacity = MIN;
		}
		buffer = ByteBuffer.allocateDirect(initialcapacity);

		ioHelper = NioObjectIOHelper.getInstance(this);
	}
